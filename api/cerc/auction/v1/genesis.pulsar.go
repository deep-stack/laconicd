...
func init() {
	file_cerc_auction_v1_genesis_proto_init()
	md_GenesisState = File_cerc_auction_v1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_cerc_auction_v1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message cerc.auction.v1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cerc.auction.v1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cerc.auction.v1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cerc/auction/v1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_cerc_auction_v1_genesis_proto_rawDescGZIP(), []int{0}
}
...
var File_cerc_auction_v1_genesis_proto protoreflect.FileDescriptor

var file_cerc_auction_v1_genesis_proto_rawDesc = []byte{
...
var (
	file_cerc_auction_v1_genesis_proto_rawDescOnce sync.Once
	file_cerc_auction_v1_genesis_proto_rawDescData = file_cerc_auction_v1_genesis_proto_rawDesc
)

func file_cerc_auction_v1_genesis_proto_rawDescGZIP() []byte {
	file_cerc_auction_v1_genesis_proto_rawDescOnce.Do(func() {
		file_cerc_auction_v1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_cerc_auction_v1_genesis_proto_rawDescData)
	})
	return file_cerc_auction_v1_genesis_proto_rawDescData
}

var file_cerc_auction_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func init() { file_cerc_auction_v1_genesis_proto_init() }
func file_cerc_auction_v1_genesis_proto_init() {
	if File_cerc_auction_v1_genesis_proto != nil {
		return
	}
	file_cerc_auction_v1_auction_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_cerc_auction_v1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cerc_auction_v1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cerc_auction_v1_genesis_proto_goTypes,
		DependencyIndexes: file_cerc_auction_v1_genesis_proto_depIdxs,
		MessageInfos:      file_cerc_auction_v1_genesis_proto_msgTypes,
	}.Build()
	File_cerc_auction_v1_genesis_proto = out.File
	file_cerc_auction_v1_genesis_proto_rawDesc = nil
	file_cerc_auction_v1_genesis_proto_goTypes = nil
	file_cerc_auction_v1_genesis_proto_depIdxs = nil
}
