...
var file_cerc_onboarding_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_cerc_onboarding_v1_query_proto_goTypes = []interface{}{
	...
	(*Participant)(nil),               // 3: cerc.onboarding.v1.Participant
	(*v1beta1.PageResponse)(nil),      // 4: cosmos.base.query.v1beta1.PageResponse
}
var file_cerc_onboarding_v1_query_proto_depIdxs = []int32{
	2, // 0: cerc.onboarding.v1.QueryParticipantsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	3, // 1: cerc.onboarding.v1.QueryParticipantsResponse.participants:type_name -> cerc.onboarding.v1.Participant
	4, // 2: cerc.onboarding.v1.QueryParticipantsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0, // 3: cerc.onboarding.v1.Query.Participants:input_type -> cerc.onboarding.v1.QueryParticipantsRequest
	1, // 4: cerc.onboarding.v1.Query.Participants:output_type -> cerc.onboarding.v1.QueryParticipantsResponse
